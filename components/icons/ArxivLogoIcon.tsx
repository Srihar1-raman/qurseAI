...
export function ArxivLogoIcon({ className, size = 16, style, 'aria-label': ariaLabel }: BaseIconProps) {
  ...
  return (
    <svg
      ...
      className={className}
      style={style}
      aria-label={ariaLabel || 'arxiv-logo'}
      role="img"
    >
      <g id="arxiv-icon">
        ...
        <path d="M562.4,295.151l9.556,11.5,5.761-5.356a7.926,7.926,0,0,0,.041-11.743l-43.7-41.923s-1.671-2.029-3.437-2.071a4.49,4.49,0,0,0-4.23,2.718c-.688,1.651-.194,2.809,1.315,4.97l29.306,35.565Z" transform="translate(-526.086 -245.559)" fill={strokeColor}/>
        <path d="M553.7,306.223l-17.116,21.024c-1.255,1.337-2.032,3.683-1.331,5.367a4.587,4.587,0,0,0,4.287,2.841,4.087,4.087,0,0,0,3.082-1.523l20.328-18.9Z" transform="translate(-526.086 -245.559)" fill={strokeColor}/>
        <path d="M592.074,250.547" transform="translate(-526.086 -245.559)" fill={strokeColor} stroke="#000" strokeMiterlimit="10" strokeWidth="0.25"/>
      </g>
    </svg>
  );
}
