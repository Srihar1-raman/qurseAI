-- MIGRATION: Update transfer_guest_to_user to include pinned field
-- Safe to run multiple times (CREATE OR REPLACE)
-- =====================================================

-- Update transfer_guest_to_user to include pinned field
...
BEGIN
  ...
  -- Include pinned field in transfer
  INSERT INTO conversations (id, user_id, title, created_at, updated_at, pinned)
  SELECT id, p_user_id, title, created_at, updated_at, COALESCE(pinned, false)
